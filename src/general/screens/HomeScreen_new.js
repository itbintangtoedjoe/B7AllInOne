  ...
  const AppBanner = () => {
    ...
    return (
      ...
      >
        ...
        />
        <Pagination
          dotsLength={bannerHardCoded.length}
          // dotsLength={2}
    ...
    return (
      ...
      >
        <Carousel
          ...
          initialNumToRender={dataBro.length}
          removeClippedSubviews={true}
          contentContainerCustomStyle={{ minWidth: width * dataBro.length }}
          loopClonesPerSide={dataBro.length}
          useScrollView={true}
          // loop={true}
          // autoplay={true}
          // autoplayInterval={2000}
  ...
  return (
    <Block flex style={styles.profile}>
      <Block style={styles.welcomeSection}>
        ...
        {/* <Block style={styles.nameSection}>
          <MilliardText style={{color: 'white', fontSize: 16}}>
            Welcome,
          </MilliardText>
          <MilliardText style={{color: 'white', fontSize: 18}}>
