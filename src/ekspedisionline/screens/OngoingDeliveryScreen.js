...
const OngoingDeliveryScreen = props => {
  ...
  useEffect(() => {
    ...
    dispatch(actions.fetchHistoriPengiriman('', activeUser));
  }, [dispatch]);
  ...
  if (historiPengiriman.length === 0) {
    return (
      <View style={styles.content}>
        <Text style={styles.regularText}>Tidak ada pengiriman berlangsung</Text>
      </View>
    );
  }
  ...
  return (
    <View>
      ...
      <View style={styles.form}>
        <View>
          <Text style={styles.sectionTitle}>LIST PENGIRIMAN BERLANGSUNG</Text>
        </View>
        <View>
          {/* <DataTable>
            <DataTable.Header>
